...
class _TvScreenState extends State<TvScreen> {
  ...
  // Function to update a document in the "Tv" collection
  Future<void> updateTv(String docId, Map<String, dynamic> updatedData) async {
    await _firestore.collection('TV').doc(docId).update(updatedData);
  }
        ...
        child: SingleChildScrollView(
          ...
          child: SingleChildScrollView(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: _firestore.collection('TV').snapshots(),
              builder: (context, snapshot) {
                ...
                final tvDocs = snapshot.data!.docs;
