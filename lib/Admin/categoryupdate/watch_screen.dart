...
class _WatchScreenState extends State<WatchScreen> {
  ...
  // Function to update a document in the "Watch" collection
  Future<void> updateWatch(
      String docId, Map<String, dynamic> updatedData) async {
    await _firestore.collection('Watch').doc(docId).update(updatedData);
  }
        ...
        child: SingleChildScrollView(
          ...
          child: SingleChildScrollView(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: _firestore.collection('Watch').snapshots(),
              builder: (context, snapshot) {
                ...
                final watchDocs = snapshot.data!.docs;
