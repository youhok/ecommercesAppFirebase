...
class EditProduct extends StatefulWidget {
  ...
  const EditProduct({Key? key, required this.productId, required this.productData}) : super(key: key);
...
class _EditProductState extends State<EditProduct> {
  ...
  final String cloudinaryUrl = "https://api.cloudinary.com/v1_1/dvkilp8oc/image/upload";
  final String uploadPreset = "storageimage";

  @override
  void initState() {
    super.initState();
    // Prefill text fields with the product's current data
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20.0),
              Text("Product Name", style: TextStyle(fontSize: 16, color: Colors.grey)),
              SizedBox(height: 20.0),
              Container(
              ...
              SizedBox(height: 20.0),
              Text("Product Price", style: TextStyle(fontSize: 16, color: Colors.grey)),
              SizedBox(height: 20.0),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
                decoration: BoxDecoration(
              ...
              SizedBox(height: 20.0),
              Text("Product Detail", style: TextStyle(fontSize: 16, color: Colors.grey)),
              SizedBox(height: 20.0),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
                decoration: BoxDecoration(
